...
pub trait RoomMembershipApi {
    fn ban(&self, room_id: &str, ban_req: ::models::BanReq) -> Result<Value, Error>;
    ...
    fn unban(&self, room_id: &str, user_id: ::models::UserId) -> Result<Value, Error>;
}
...
impl RoomMembershipApi for RoomMembershipApiClient {
    fn ban(&self, room_id: &str, ban_req: ::models::BanReq) -> Result<Value, Error> {
        ...
        let uri_str = format!("{}/client/r0/rooms/{roomId}/ban", configuration.base_path, roomId=urlencode(room_id));
        ...
        req_builder = req_builder.json(&ban_req);
    ...
    fn unban(&self, room_id: &str, user_id: ::models::UserId) -> Result<Value, Error> {
        ...
        let uri_str = format!("{}/client/r0/rooms/{roomId}/unban", configuration.base_path, roomId=urlencode(room_id));
        let mut req_builder = client.post(uri_str.as_str());
